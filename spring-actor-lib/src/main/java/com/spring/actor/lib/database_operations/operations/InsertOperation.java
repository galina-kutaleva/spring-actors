...
public class InsertOperation implements IDatabaseOperation<Map<String, Object>> {

    private final JdbcOperations jdbcOperations;
    private final ObjectMapper objectMapper;

    public InsertOperation(final JdbcOperations jdbcOperations, final ObjectMapper objectMapper) {
